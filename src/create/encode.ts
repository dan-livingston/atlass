...
type Encoded = { value: unknown } | { problem: string };
...
function matchAllowed(field: CreateField, token: string): Encoded {
...
function matchCascading(field: CreateField, value: string): Encoded {
	const options = field.allowedValues ?? [];
